...
async function main() {
  ...
  function renderPriceChart() {
    ...
    // Draw threshold history last so crossings with actual price do not make
    // the dashed curves look broken. Start once the as-of regression has a
    // full year of observations, then continue without a recent-date cutoff.
    if(fullProjectionView) {
