...
export default function BitcoinRiskMetricPage() {
  return (
    <main id="main-content" tabIndex={-1} className="spy-page btc-page risk-page-with-sections" data-risk-dashboard="btc">
      ...
      <div className="spy-container">
        ...
        <section className="dashboard" id="summary" aria-label="Bitcoin market summary">
          <article className="card card-price">
            ...
            <div className="card-sub" id="vSatoshiPrice" style={{ fontWeight: 700 }}>$1 USD ≈ — sats</div>
          </article>
        ...
        <section className="spy-panel methodology" id="methodology">
          ...
          <div className="methodology-grid">
            ...
            <p>
              ...
              pulled lower. Zones are Generational below 0.10, Accumulate from 0.10–0.25, Neutral from 0.25, Elevated from 0.50, Caution from 0.75, and Euphoria from 0.90 through 1.00.
            </p>
            <p>
      ...
      <Script src="/btc-risk-engine.js?v=20260925-proportional-zones" strategy="afterInteractive" />
    </main>
  );
}
